...
$((function(){$(".select-style").styler(),$(".filter-price__input").ionRangeSlider({type:"double",prefix:"$",onStart:function(e){$(".filter-price__from").text(e.from),$(".filter-price__to").text(e.to)},onChange:function(e){}}),$(".top-slider__inner").slick({dots:!0,arrows:!1,fade:!0,autoplay:!0,autoplaySpeed:2e3}),$(".star").rateYo({starWidth:"17px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0});!function(e,t){const o=document.querySelector(".promo__clock"),r=o.querySelector(".promo__days"),n=o.querySelector(".promo__hours"),c=o.querySelector(".promo__minutes"),l=o.querySelector(".promo__seconds");function a(){const e=function(e){const t=Date.parse(e)-Date.parse(new Date),o=Math.floor(t/1e3%60),r=Math.floor(t/1e3/60%60),n=Math.floor(t/36e5%24);return{total:t,days:Math.floor(t/864e5),hours:n,minutes:r,seconds:o}}(t);r.innerHTML=e.days,n.innerHTML=("0"+e.hours).slice(-2),c.innerHTML=("0"+e.minutes).slice(-2),l.innerHTML=("0"+e.seconds).slice(-2),e.total<=0&&clearInterval(s)}a();const s=setInterval(a,1e3)}(0,$(".promo__clock").attr("data-time"))}));