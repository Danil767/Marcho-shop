...
$((function(){$(".shop-content__filter-btn").on("click",(function(){$(".shop-content__filter-btn").removeClass("shop-content__filter-btn--active"),$(this).addClass("shop-content__filter-btn--active")})),$(".button-list").on("click",(function(){$(".product-item").addClass("product-item--list")})),$(".button-grid").on("click",(function(){$(".product-item").removeClass("product-item--list")})),$(".select-style").styler(),$(".filter-price__input").ionRangeSlider({type:"double",prefix:"$",onStart:function(t){$(".filter-price__from").text(t.from),$(".filter-price__to").text(t.to)},onChange:function(t){}}),$(".top-slider__inner").slick({dots:!0,arrows:!1,fade:!0,autoplay:!0,autoplaySpeed:2e3}),$(".star").rateYo({starWidth:"17px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0});!function(t,e){const o=document.querySelector(".promo__clock"),n=o.querySelector(".promo__days"),r=o.querySelector(".promo__hours"),c=o.querySelector(".promo__minutes"),i=o.querySelector(".promo__seconds");function l(){const t=function(t){const e=Date.parse(t)-Date.parse(new Date),o=Math.floor(e/1e3%60),n=Math.floor(e/1e3/60%60),r=Math.floor(e/36e5%24);return{total:e,days:Math.floor(e/864e5),hours:r,minutes:n,seconds:o}}(e);n.innerHTML=t.days,r.innerHTML=("0"+t.hours).slice(-2),c.innerHTML=("0"+t.minutes).slice(-2),i.innerHTML=("0"+t.seconds).slice(-2),t.total<=0&&clearInterval(s)}l();const s=setInterval(l,1e3)}(0,$(".promo__clock").attr("data-time"))}));