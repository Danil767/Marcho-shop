...
$((function(){$(".filter-price__input").ionRangeSlider({type:"double",prefix:"$",onStart:function(e){$(".filter-price__from").text(e.from),$(".filter-price__to").text(e.to)},onChange:function(e){}}),$(".top-slider__inner").slick({dots:!0,arrows:!1,fade:!0,autoplay:!0,autoplaySpeed:2e3}),$(".star").rateYo({starWidth:"17px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0});!function(e,o){const t=document.querySelector(".promo__clock"),r=t.querySelector(".promo__days"),n=t.querySelector(".promo__hours"),c=t.querySelector(".promo__minutes"),a=t.querySelector(".promo__seconds");function l(){const e=function(e){const o=Date.parse(e)-Date.parse(new Date),t=Math.floor(o/1e3%60),r=Math.floor(o/1e3/60%60),n=Math.floor(o/36e5%24);return{total:o,days:Math.floor(o/864e5),hours:n,minutes:r,seconds:t}}(o);r.innerHTML=e.days,n.innerHTML=("0"+e.hours).slice(-2),c.innerHTML=("0"+e.minutes).slice(-2),a.innerHTML=("0"+e.seconds).slice(-2),e.total<=0&&clearInterval(i)}l();const i=setInterval(l,1e3)}(0,$(".promo__clock").attr("data-time"))}));